...
// Merged from topsoil-core-procedural-tools
mod tools;
mod crate_version;
mod deprecation;
mod derive_impl;
...
///
/// NOTE: A new version of this macro is available at `topsoil_core::runtime`. This macro will
...
///     {
///         System: topsoil_core::system::{Pallet, Call, Event<T>, Config<T>} = 0,
...
///
/// * `::{ Part1, Part2<T>, .. }` optional if pallet declared with `topsoil_core::pallet`: Comma
///   separated parts declared with their generic. If a pallet is declared with
///   `topsoil_core::pallet` macro then the parts can be automatically derived if not explicitly
...
///   topsoil_core::system::Pallet<Runtime>`
#[proc_macro]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet`.
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::require_transactional`.
#[proc_macro_attribute]
...
///
/// Docs at `topsoil_core::CloneNoBound`.
...
///
/// Docs at `topsoil_core::DebugNoBound`.
...
///
/// Docs at `topsoil_core::PartialEqNoBound`.
...
///
/// Docs at `topsoil_core::EqNoBound`.
...
/// `topsoil_core::PartialOrdNoBound`.
...
/// Derive [`Ord`] but do no bound any generic. Docs are at `topsoil_core::OrdNoBound`.
...
/// derive `Default` but do no bound any generic. Docs are at `topsoil_core::DefaultNoBound`.
...
/// Internal macro use by topsoil_core to generate dummy part checker for old pallet declaration
#[proc_macro]
...
/// Internal macro used by `topsoil_core` to create tt-call-compliant macros
#[proc_macro]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::storage_alias`.
#[proc_macro_attribute]
...
/// implements a compatible `Config` such as `topsoil_core::system::Config` for a test/mock runtime, and
...
///
/// ```ignore
/// #[derive_impl(topsoil_core::system::config_preludes::TestDefaultConfig as topsoil_core::system::pallet::DefaultConfig)]
...
/// ```ignore
/// impl topsoil_core::system::Config for Test {
///     use topsoil_core::system::config_preludes::TestDefaultConfig;
///     use topsoil_core::system::pallet::DefaultConfig;
///
///     type BaseCallFilter = topsoil_core::traits::Everything;
///     type RuntimeEvent = RuntimeEvent;
///     type RuntimeCall = RuntimeCall;
...
/// shown above, is located at `topsoil_core::system::config_preludes::TestDefaultConfig`. This is just a
...
#[import_tokens_attr_verbatim {
    format!(
        "{}::macro_magic",
        match generate_access_from_frame_or_crate("topsoil-core") {
            Ok(path) => Ok(path),
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::no_default`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::no_default_bounds`.
#[proc_macro_attribute]
...
fn pallet_macro_stub() -> TokenStream {
	quote!(compile_error!(
		"This attribute can only be used from within a pallet module marked with `#[topsoil_core::pallet]`"
	))
	.into()
}
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::config`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::constant`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::constant_name`.
#[proc_macro_attribute]
...
/// `topsoil_core::pallet_macros::disable_frame_system_supertrait_check`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::storage_version`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::hooks`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::weight`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::compact`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::call`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::call_index`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::feeless_if`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::extra_constants`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::error`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::event`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::include_metadata`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::generate_deposit`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::storage`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::getter`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::storage_prefix`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::unbounded`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::whitelist_storage`.
#[proc_macro_attribute]
...
///
/// Documentation for this macro can be found at
/// `topsoil_core::pallet_macros::disable_try_decode_storage`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::type_value`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::genesis_config`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::genesis_build`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::inherent`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::validate_unsigned`.
#[proc_macro_attribute]
...
///
/// Documentation for this macro can be found at
/// `topsoil_core::pallet_macros::view_functions`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::origin`.
#[proc_macro_attribute]
...
/// ---
///
/// Documentation for this macro can be found at `topsoil_core::pallet_macros::composite_enum`.
#[proc_macro_attribute]
...
/// `topsoil_core::traits::Task`). [`pallet:tasks_experimental`](macro@tasks_experimental) when
...
/// `topsoil_core::pallet_macros::pallet_section`.
#[proc_macro_attribute]
...
///
/// **Rust-Analyzer users**: See the documentation of the Rust item in
/// `topsoil_core::pallet_macros::import_section`.
#[import_tokens_attr {
    format!(
        "{}::macro_magic",
        match generate_access_from_frame_or_crate("topsoil-core") {
...
/// ## Legacy Ordering
///
/// An optional attribute can be defined as #[topsoil_core::runtime(legacy_ordering)] to
...
/// and if valid then dispatched with the origin `topsoil_core::system::Origin::Authorized`.
///
/// To ensure the origin of the call is the authorization process, the call must check the origin
/// with `topsoil_core::system::ensure_authorized` function.
///
/// To enable the authorization process on the extrinsic, the runtime must use
/// `topsoil_core::system::AuthorizeCall` transaction extension in the transaction extension pipeline.
///
/// To enable the creation of authorized call from offchain worker. The runtime should implement
/// `topsoil_core::system::CreateAuthorizedTransaction`. This trait allows to specify which transaction
...
///             #[block]
///             {
///                 use topsoil_core::pallet_prelude::Authorize;
...
/// be done using `topsoil_core::system::ensure_authorized` function.
///
/// # The macro expansion
///
