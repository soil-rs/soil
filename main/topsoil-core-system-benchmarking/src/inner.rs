...
use topsoil_core::{dispatch::DispatchClass, storage, traits::Get};
use topsoil_core::system::{Call, Pallet as System, RawOrigin};
...
pub trait Config: topsoil_core::system::Config {
	...
	fn verify_set_code() {
		System::<Self>::assert_last_event(topsoil_core::system::Event::<Self>::CodeUpdated.into());
	}
}
...
mod benchmarks {
	...
	fn remark_with_event(
		...
		System::<T>::assert_last_event(
			topsoil_core::system::Event::<T>::Remarked { sender: caller, hash }.into(),
		);
		Ok(())
	}
