...
pub trait KeyGenerator {
	...
	const HASHER_METADATA: &'static [subsoil::metadata_ir::StorageHasherIR];
...
impl<H: StorageHasher, K: FullCodec + StaticTypeInfo> KeyGenerator for Key<H, K> {
	...
	const HASHER_METADATA: &'static [subsoil::metadata_ir::StorageHasherIR] = &[H::METADATA];
...
topsoil_core_procedural::impl_key_prefix_for_tuples!();
