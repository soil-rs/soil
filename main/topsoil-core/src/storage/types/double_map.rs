...
use topsoil_core::storage::StorageDecodeNonDedupLength;
...
/// [`StorageMap`](topsoil_core::storage::types::StorageMap) with a key of type `(k1, k2)`.
...
/// [`StorageNMap`](topsoil_core::storage::types::StorageNMap) using two keys.
///
...
/// [`ReversibleStorageHasher`](topsoil_core::ReversibleStorageHasher) trait, the first key `k1`
	...
	MaxValues: Get<Option<u32>>,
{
	...
	pub fn remove_prefix<KArg1>(k1: KArg1, limit: Option<u32>) -> subsoil::io::KillStorageResult
	where
