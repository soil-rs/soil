...
///
/// ```should_panic
/// topsoil_core::defensive_assert!(1 == 0, "Must fail")
/// ```
#[macro_export]
...
pub trait DefensiveTruncateFrom<T> {
	...
	///
	/// ```
	/// use topsoil_core::{BoundedVec, traits::DefensiveTruncateFrom};
...
pub trait DefensiveMin<T> {
	...
	///
	/// ```
	/// use topsoil_core::traits::DefensiveMin;
	/// // min(3, 4) is 3.
...
pub trait DefensiveMax<T> {
	...
	///
	/// ```
	/// use topsoil_core::traits::DefensiveMax;
	/// // max(4, 3) is 4.
...
///
/// ```
/// # use topsoil_core::traits::IsSubType;
///
/// enum Test {
///     String(String),
///     U32(u32),
