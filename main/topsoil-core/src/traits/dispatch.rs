...
///
/// ```rust
/// # use topsoil_core::traits::{EnsureOriginEqualOrHigherPrivilege, PrivilegeCmp, EnsureOrigin as _};
/// # use subsoil::runtime::traits::{parameter_types, Get};
...
pub trait UnfilteredDispatchable {
	/// The origin type of the runtime, (i.e. `topsoil_core::system::Config::RuntimeOrigin`).
	type RuntimeOrigin;
...
/// Methods available on `topsoil_core::system::Config::RuntimeOrigin`.
pub trait OriginTrait: Sized {
	/// Runtime call type, as in `topsoil_core::system::Config::Call`
	type Call;
	...
	/// Reset origin filters to default one, i.e `topsoil_core::system::1fig::BaseCallFilter`.
	...
	/// Create with system none origin and `topsoil_core::system::Config::BaseCallFilter`.
	fn none() -> Self;

	/// Create with system root origin and `topsoil_core::system::Config::BaseCallFilter`.
	fn root() -> Self;

	/// Create with system signed origin and `topsoil_core::system::Config::BaseCallFilter`.
...
/// `topsoil_core::system::AuthorizeCall` transaction extension.
///
