...
/// [`topsoil_core::MAX_MODULE_ERROR_ENCODED_SIZE`]. If the pallet error type exceeds this size
...
pub trait PalletError: Encode + Decode {
	...
	/// [`topsoil_core::MAX_MODULE_ERROR_ENCODED_SIZE`], and if it is, a compilation error will be
	/// thrown.
