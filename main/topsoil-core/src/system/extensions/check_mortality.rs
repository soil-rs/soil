...
use crate::system::{pallet_prelude::BlockNumberFor, BlockHash, Config, Pallet};
...
mod tests {
	use super::*;
	use crate::system::mock::{new_test_ext, System, Test, CALL};
	...
	fn signed_ext_check_era_should_change_longevity() {
		new_test_ext().execute_with(|| {
			...
			let len = 0_usize;
			let ext = (
				crate::system::CheckWeight::<Test>::new(),
