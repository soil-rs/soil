...
use crate::system::{limits::BlockWeights, Config, Pallet, LOG_TARGET};
	...
	T::RuntimeCall: Dispatchable<Info = DispatchInfo, PostInfo = PostDispatchInfo>,
{
	...
	pub fn do_prepare(
		...
		crate::system::BlockSize::<T>::put(next_len);
		crate::system::BlockWeight::<T>::put(next_weight);
		Ok(())
	}
...
pub fn calculate_consumed_weight<Call>(
	...
	mut all_weight: crate::system::ConsumedWeight,
	info: &DispatchInfoOf<Call>,
	len: usize,
) -> Result<crate::system::ConsumedWeight, TransactionValidityError>
where
...
mod tests {
	...
	use topsoil_core::{assert_err, assert_ok, dispatch::Pays, weights::Weight};
	...
	fn no_max_total_should_still_be_limited_by_max_block() {
		...
		let maximum_weight = BlockWeights::builder()
			...
			.build_or_panic();
		let all_weight = crate::system::ConsumedWeight::new(|class| match class {
