...
//! Autogenerated weights for `topsoil_system`
//!
...
/// Weight functions needed for `topsoil_system`.
...
/// Weights for `topsoil_system` using the Substrate node and recommended hardware.
pub struct SubstrateWeight<T>(PhantomData<T>);
impl<T: crate::system::Config> WeightInfo for SubstrateWeight<T> {
