...
/// (for enactment there's `EstimateNextSessionRotation`). With `plant-session` this should be
...
/// been registered with them. The [Session module](../../plant_session/index.html) is an
/// implementor.
