...
fn create_signed_statement(
	...
	keypair: &subsoil::core::ed25519::Pair,
) -> Statement {
...
fn setup_store(keypair: &subsoil::core::ed25519::Pair) -> (Store, tempfile::TempDir) {
	...
	path.push("db");
	let keystore = Arc::new(soil_client::keystore::LocalKeystore::in_memory());
