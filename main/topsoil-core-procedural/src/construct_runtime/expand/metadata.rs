		...
		impl #runtime {
			...
			fn metadata_ir() -> #scrate::__private::metadata_ir::MetadataIR {
				...
				let call_ty = #scrate::__private::scale_info::meta_type::<
						<#extrinsic as #scrate::subsoil::runtime::traits::ExtrinsicCall>::Call
					>();
				...
				#scrate::__private::metadata_ir::MetadataIR {
					...
					extrinsic: #scrate::__private::metadata_ir::ExtrinsicMetadataIR {
						ty,
						versions: <#extrinsic as #scrate::subsoil::runtime::traits::ExtrinsicMetadata>::VERSIONS.into_iter().map(|ref_version| *ref_version).collect(),
						address_ty,
						call_ty,
						signature_ty,
						extra_ty,
						extensions: <
								<
									#extrinsic as #scrate::subsoil::runtime::traits::ExtrinsicMetadata
								>::TransactionExtensions
								as
								#scrate::subsoil::runtime::traits::TransactionExtension::<
