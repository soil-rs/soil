...
pub fn expand_event(def: &mut Def) -> proc_macro2::TokenStream {
	...
	quote::quote_spanned!(event.attr_span =>
		...
		impl<#event_impl_gen> #event_ident<#event_use_gen> #event_where_clause {
			#[allow(dead_code)]
			#[doc(hidden)]
			pub fn event_metadata<W: #topsoil_core::__private::scale_info::TypeInfo + 'static>() -> #topsoil_core::__private::metadata_ir::PalletEventMetadataIR {
				#topsoil_core::__private::metadata_ir::PalletEventMetadataIR {
					ty: #topsoil_core::__private::scale_info::meta_type::<W>(),
