...
use alloc::vec::Vec;
use crate::staking::SessionIndex;
...
impl GetSessionNumber for crate::core::Void {
	fn session(&self) -> SessionIndex {
		Default::default()
	}
}

impl GetValidatorCount for crate::core::Void {
	fn validator_count(&self) -> ValidatorCount {
		Default::default()
	}
}
...
pub fn generate_initial_session_keys<Block, T>(
	...
	at: Block::Hash,
	seeds: Vec<String>,
	keystore: crate::keystore::KeystorePtr,
	...
	T::Api: SessionKeys<Block>,
{
	...
	runtime_api.register_extension(crate::keystore::KeystoreExt::from(keystore));
