...
use self::currency_to_vote::CurrencyToVote;
...
where
	Balance: HasCompact
		...
		+ Add<Output = Balance>
		+ Sub<Output = Balance>
		+ crate::runtime::Saturating
		+ PartialEq
		+ Copy
		+ crate::runtime::traits::Debug,
{
	...
	pub fn update_with<Max: crate::core::Get<u32>>(
		self,
