...
use super::super::ext::StorageAppend;
#[cfg(feature = "std")]
...
impl From<crate::core::storage::StorageMap> for OverlayedMap<StorageKey, StorageEntry> {
	fn from(storage: crate::core::storage::StorageMap) -> Self {
		Self {
			changes: storage
				.into_iter()
				.map(|(k, v)| {
