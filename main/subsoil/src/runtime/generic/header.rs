...
mod tests {
	...
	fn ensure_format_is_unchanged() {
		let header = Header::<u32, BlakeTwo256> {
			...
			digest: crate::runtime::generic::Digest {
				logs: vec![crate::runtime::generic::DigestItem::Other(b"6".to_vec())],
			},
		};
		...
		let header = Header::<u32, BlakeTwo256> {
			...
			digest: crate::runtime::generic::Digest {
				logs: vec![crate::runtime::generic::DigestItem::Other(b"5000".to_vec())],
			},
		};
