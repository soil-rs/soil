	...
	Key: Encode,
{
	...
	pub fn create_multi_proof(&self, keys: &[Key]) -> Result<Vec<u8>, DispatchError> {
		crate::trie::generate_trie_proof::<LayoutV1<Hashing>, _, _, _>(
			&self.db,
			self.root,
	...
	Value: Encode,
{
	...
	crate::trie::verify_trie_proof::<LayoutV1<Hashing>, _, _, _>(
		&root,
		&structured_proof,
...
mod tests {
	...
	fn empty_root() -> H256 {
		crate::trie::empty_trie_root::<LayoutV1<BlakeTwo256>>()
	}
