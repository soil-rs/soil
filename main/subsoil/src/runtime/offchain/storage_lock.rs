...
impl Lockable for Time {
	...
	fn snooze(deadline: &Self::Deadline) {
		...
		crate::io::offchain::sleep_until(now.add(snooze));
	}
}
...
mod tests {
	use super::*;
	use crate::core::offchain::{testing, OffchainDbExt, OffchainWorkerExt};
