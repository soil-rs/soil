...
use soil_core::{
	crypto::{
		AppCrypto, AppPair, ByteArray, ExposeSecret, IsWrappedBy, KeyTypeId,
		Pair as CorePair, SecretString, VrfSecret,
	},
	ecdsa, ed25519, sr25519,
};
use crate::{Error as TraitError, Keystore, KeystorePtr};
use std::{
	collections::HashMap,
	fs::{self, File},
	io::Write,
...
crate::bandersnatch_experimental_enabled! {
use soil_core::bandersnatch;
}

crate::bls_experimental_enabled! {
