...
use crate::{
	...
	error::Error,
	client::find_authorities_change,
	fisherman::Fisherman,
	...
	client::{BeefyComms, BeefyVoterLinks, UnpinnedFinalityNotification, LOG_TARGET},
};
	...
	AuthorityId: AuthorityIdBound,
{
	...
	pub(crate) async fn run(
		...
		>,
		finality_notifications: &mut Fuse<crate::client::FinalityNotifications<B>>,
