...
use super::client::{Epoch, AUTHORING_SCORE_LENGTH, AUTHORING_SCORE_VRF_CONTEXT};
use codec::Encode;
...
pub(crate) fn calculate_primary_threshold(
	c: (u64, u64),
...
pub(crate) fn secondary_slot_author(
	slot: Slot,
	authorities: &[(AuthorityId, BabeAuthorityWeight)],
	...
	let rand =
		U256::from_big_endian(&(randomness, slot).using_encoded(soil_crypto_hashing::blake2_256));
