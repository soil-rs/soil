...
//! Autogenerated weights for `plant_core_fellowship`
//!
...
/// Weight functions needed for `plant_core_fellowship`.
...
/// Weights for `plant_core_fellowship` using the Substrate node and recommended hardware.
