...
//! Autogenerated weights for `plant_lottery`
//!
...
/// Weight functions needed for `plant_lottery`.
...
/// Weights for `plant_lottery` using the Substrate node and recommended hardware.
