...
//! Autogenerated weights for `plant_fast_unstake`
//!
...
/// Weight functions needed for `plant_fast_unstake`.
...
/// Weights for `plant_fast_unstake` using the Substrate node and recommended hardware.
