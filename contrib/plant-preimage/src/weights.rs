...
//! Autogenerated weights for `plant_preimage`
//!
...
/// Weight functions needed for `plant_preimage`.
...
/// Weights for `plant_preimage` using the Substrate node and recommended hardware.
