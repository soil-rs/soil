...
//! Autogenerated weights for `plant_uniques`
//!
...
/// Weight functions needed for `plant_uniques`.
...
/// Weights for `plant_uniques` using the Substrate node and recommended hardware.
