...
//! Autogenerated weights for `plant_bounties`
//!
...
/// Weight functions needed for `plant_bounties`.
...
/// Weights for `plant_bounties` using the Substrate node and recommended hardware.
