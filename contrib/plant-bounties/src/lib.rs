...
type BalanceOf<T, I = ()> = plant_treasury::BalanceOf<T, I>;

type PositiveImbalanceOf<T, I = ()> = plant_treasury::PositiveImbalanceOf<T, I>;
...
pub mod pallet {
		...
		topsoil_core::system::Config + plant_treasury::Config<I>
	{
		...
		type OnSlash: OnUnbalanced<plant_treasury::NegativeImbalanceOf<Self, I>>;
		...
		pub fn approve_bounty(
			...
			Bounties::<T, I>::try_mutate_exists(bounty_id, |maybe_bounty| -> DispatchResult {
				let bounty = maybe_bounty.as_mut().ok_or(Error::<T, I>::InvalidIndex)?;
					...
					plant_treasury::Error::<T, I>::InsufficientPermission
				);
...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
	...
	pub fn treasury_block_number() -> BlockNumberFor<T, I> {
		<T as plant_treasury::Config<I>>::BlockNumberProvider::current_block_number()
	}
...
impl<T: Config<I>, I: 'static> plant_treasury::SpendFunds<T, I> for Pallet<T, I> {
	fn spend_funds(
