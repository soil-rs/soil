...
pub fn pre_migration<T: plant_bounties::Config, P: GetStorageVersion + 'static, N: AsRef<str>>(
	...
	let old_pallet_name = old_pallet_name.as_ref();
	let new_pallet_name = new_pallet_name.as_ref();
	let storage_prefix_bounties_count = plant_bounties::BountyCount::<T>::storage_prefix();
	let storage_prefix_bounties = plant_bounties::Bounties::<T>::storage_prefix();
	let storage_prefix_bounties_description =
		plant_bounties::BountyDescriptions::<T>::storage_prefix();
	let storage_prefix_bounties_approvals =
		plant_bounties::BountyApprovals::<T>::storage_prefix();
