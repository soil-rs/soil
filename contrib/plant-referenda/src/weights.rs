...
//! Autogenerated weights for `plant_referenda`
//!
...
/// Weight functions needed for `plant_referenda`.
...
/// Weights for `plant_referenda` using the Substrate node and recommended hardware.
