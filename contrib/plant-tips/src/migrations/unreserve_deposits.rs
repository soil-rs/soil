...
mod test {
	...
	fn unreserve_all_funds_works() {
		...
		new_test_ext().execute_with(|| {
			// Set up
			assert_ok!(<Test as plant_treasury::Config>::Currency::reserve(
				&tipper_0,
			...
			assert_eq!(
				<Test as plant_treasury::Config>::Currency::reserved_balance(&tipper_0),
				tipper_0_initial_reserved
			...
			assert_eq!(
				<Test as plant_treasury::Config>::Currency::reserved_balance(&tipper_1),
				tipper_1_initial_reserved
					+ <Test as crate::Config>::TipReportDepositBase::get()
					+ <Test as crate::Config>::DataDepositPerByte::get()
