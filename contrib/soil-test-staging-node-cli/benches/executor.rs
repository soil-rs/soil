...
const TRANSACTION_VERSION: u32 = soil_test_staging_node_runtime::VERSION.transaction_version;

const SPEC_VERSION: u32 = soil_test_staging_node_runtime::VERSION.spec_version;
...
fn bench_execute_block(c: &mut Criterion) {
	...
	group.bench_function("wasm", |b| {
		let genesis_config = soil_test_staging_node_testing::genesis::config();
