...
//! Autogenerated weights for `plant_staking`
//!
...
/// Weight functions needed for `plant_staking`.
...
/// Weights for `plant_staking` using the Substrate node and recommended hardware.
