...
//! Autogenerated weights for `plant_treasury`
//!
...
/// Weight functions needed for `plant_treasury`.
...
/// Weights for `plant_treasury` using the Substrate node and recommended hardware.
