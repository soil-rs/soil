...
//! Autogenerated weights for `plant_parameters`
//!
...
/// Weight functions needed for `plant_parameters`.
pub trait WeightInfo {
	fn set_parameter() -> Weight;
}

/// Weights for `plant_parameters` using the Substrate node and recommended hardware.
