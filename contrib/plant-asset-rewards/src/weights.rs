...
//! Autogenerated weights for `plant_asset_rewards`
//!
...
/// Weight functions needed for `plant_asset_rewards`.
...
/// Weights for `plant_asset_rewards` using the Substrate node and recommended hardware.
