...
//! Autogenerated weights for `plant_election_provider_multi_phase`
//!
...
// --pallet=plant_election_provider_multi_phase
...
/// Weight functions needed for `plant_election_provider_multi_phase`.
...
/// Weights for `plant_election_provider_multi_phase` using the Substrate node and recommended hardware.
