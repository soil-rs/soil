...
//! Autogenerated weights for `plant_conviction_voting`
//!
...
// --pallet=plant_conviction_voting
...
/// Weight functions needed for `plant_conviction_voting`.
...
/// Weights for `plant_conviction_voting` using the Substrate node and recommended hardware.
