...
//! Autogenerated weights for `plant_scheduler`
//!
...
/// Weight functions needed for `plant_scheduler`.
...
/// Weights for `plant_scheduler` using the Substrate node and recommended hardware.
