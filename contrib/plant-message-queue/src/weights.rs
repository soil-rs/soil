...
//! Autogenerated weights for `plant_message_queue`
//!
...
/// Weight functions needed for `plant_message_queue`.
...
/// Weights for `plant_message_queue` using the Substrate node and recommended hardware.
