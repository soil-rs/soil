...
//! Autogenerated weights for `plant_glutton`
//!
...
/// Weight functions needed for `plant_glutton`.
...
/// Weights for `plant_glutton` using the Substrate node and recommended hardware.
