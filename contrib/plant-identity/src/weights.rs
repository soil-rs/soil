...
//! Autogenerated weights for `plant_identity`
//!
...
/// Weight functions needed for `plant_identity`.
...
/// Weights for `plant_identity` using the Substrate node and recommended hardware.
