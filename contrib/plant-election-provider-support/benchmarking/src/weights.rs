...
//! Autogenerated weights for `plant_election_provider_support_benchmarking`
//!
...
// --pallet=plant_election_provider_support_benchmarking
...
/// Weight functions needed for `plant_election_provider_support_benchmarking`.
pub trait WeightInfo {
	fn phragmen(v: u32, t: u32, d: u32, ) -> Weight;
	fn phragmms(v: u32, t: u32, d: u32, ) -> Weight;
}

/// Weights for `plant_election_provider_support_benchmarking` using the Substrate node and recommended hardware.
