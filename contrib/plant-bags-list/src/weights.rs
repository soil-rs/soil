...
//! Autogenerated weights for `plant_bags_list`
//!
...
/// Weight functions needed for `plant_bags_list`.
...
/// Weights for `plant_bags_list` using the Substrate node and recommended hardware.
