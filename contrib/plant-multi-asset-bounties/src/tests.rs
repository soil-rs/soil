...
fn fund_bounty_works() {
	ExtBuilder::default().build_and_execute(|| {
		...
		assert_eq!(
			plant_bounties::Bounties::<Test>::get(parent_bounty_id).unwrap(),
			Bounty {
				asset_kind,
				value,
				metadata,
		...
		assert_eq!(
			plant_bounties::CuratorDeposit::<Test>::get(parent_bounty_id, None::<BountyIndex>),
			None
		);
	});
}
...
fn fund_child_bounty_works() {
	ExtBuilder::default().build_and_execute(|| {
		...
		s.child_bounty_id =
			plant_bounties::TotalChildBountiesPerParent::<Test>::get(s.parent_bounty_id) - 1;
		...
		assert_eq!(
			plant_bounties::ChildBounties::<Test>::get(s.parent_bounty_id, s.child_bounty_id)
				.unwrap(),
			ChildBounty {
		...
		assert_eq!(
			plant_bounties::TotalChildBountiesPerParent::<Test>::get(s.parent_bounty_id),
			1
		);
		assert_eq!(plant_bounties::ChildBountiesPerParent::<Test>::get(s.parent_bounty_id), 1);
		assert_eq!(
			plant_bounties::ChildBountiesValuePerParent::<Test>::get(s.parent_bounty_id),
			s.child_value
		);
		assert!(Preimage::is_requested(&s.metadata));
		assert_eq!(
			plant_bounties::CuratorDeposit::<Test>::get(
				s.parent_bounty_id,
		...
		assert_eq!(
			plant_bounties::CuratorDeposit::<Test>::get(s.parent_bounty_id, None::<BountyIndex>)
				.unwrap(),
...
fn check_status_works() {
	ExtBuilder::default().build_and_execute(|| {
		...
		assert_eq!(
			plant_bounties::Bounties::<Test>::get(s.parent_bounty_id).unwrap(),
			Bounty {
		...
		assert_eq!(
			plant_bounties::Bounties::<Test>::get(s.parent_bounty_id).unwrap().status,
		...
		assert_eq!(plant_bounties::Bounties::<Test>::iter().count(), 4 - 1);
		assert_eq!(plant_bounties::Bounties::<Test>::get(s.parent_bounty_id), None);
		assert_eq!(plant_bounties::ChildBountiesPerParent::<Test>::get(s.parent_bounty_id), 0);
		assert_eq!(
			plant_bounties::TotalChildBountiesPerParent::<Test>::get(s.parent_bounty_id),
			0
		);
		...
		assert_eq!(plant_bounties::Bounties::<Test>::iter().count(), 6 - 1 - 1);
		assert_eq!(plant_bounties::Bounties::<Test>::get(s.parent_bounty_id), None);
		assert_eq!(plant_bounties::ChildBountiesPerParent::<Test>::get(s.parent_bounty_id), 0);
		assert_eq!(
			plant_bounties::TotalChildBountiesPerParent::<Test>::get(s.parent_bounty_id),
		...
		assert_eq!(
			plant_bounties::ChildBounties::<Test>::iter_prefix(s.parent_bounty_id).count(),
			1
		);
