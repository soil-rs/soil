...
parameter_types! {
	...
	pub const CuratorDepositHoldReason: RuntimeHoldReason = RuntimeHoldReason::Bounties(plant_bounties::HoldReason::CuratorDeposit);
...
pub fn get_payment_id(
	...
	let bounty =
		plant_bounties::Pallet::<Test>::get_bounty_details(parent_bounty_id, child_bounty_id)
			.expect("no bounty");
...
pub fn create_parent_bounty() -> TestBounty {
	...
	let parent_bounty_id = plant_bounties::BountyCount::<Test>::get() - 1;
