...
//! Autogenerated weights for `plant_multi_asset_bounties`
//!
...
// --pallet=plant_multi_asset_bounties
...
/// Weight functions needed for `plant_multi_asset_bounties`.
...
/// Weights for `plant_multi_asset_bounties` using the Substrate node and recommended hardware.
