...
//! Autogenerated weights for `plant_broker`
//!
...
/// Weight functions needed for `plant_broker`.
...
/// Weights for `plant_broker` using the Substrate node and recommended hardware.
