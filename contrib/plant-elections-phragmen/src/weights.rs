...
//! Autogenerated weights for `plant_elections_phragmen`
//!
...
// --pallet=plant_elections_phragmen
...
/// Weight functions needed for `plant_elections_phragmen`.
...
/// Weights for `plant_elections_phragmen` using the Substrate node and recommended hardware.
