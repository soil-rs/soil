...
//! Autogenerated weights for `plant_democracy`
//!
...
/// Weight functions needed for `plant_democracy`.
...
/// Weights for `plant_democracy` using the Substrate node and recommended hardware.
