...
//! Autogenerated weights for `plant_membership`
//!
...
/// Weight functions needed for `plant_membership`.
...
/// Weights for `plant_membership` using the Substrate node and recommended hardware.
