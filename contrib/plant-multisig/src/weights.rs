...
//! Autogenerated weights for `plant_multisig`
//!
...
/// Weight functions needed for `plant_multisig`.
...
/// Weights for `plant_multisig` using the Substrate node and recommended hardware.
