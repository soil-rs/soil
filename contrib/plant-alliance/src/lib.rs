...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
	...
	fn try_state_members_are_disjoint() -> Result<(), subsoil::runtime::TryRuntimeError> {
	...
	fn try_state_members_are_sorted() -> Result<(), subsoil::runtime::TryRuntimeError> {
	...
	fn try_state_deposit_of_is_consistent() -> Result<(), subsoil::runtime::TryRuntimeError> {
	...
	fn try_state_unscrupulous_items_are_sorted() -> Result<(), subsoil::runtime::TryRuntimeError> {
	...
	fn try_state_announcements_are_sorted() -> Result<(), subsoil::runtime::TryRuntimeError> {
