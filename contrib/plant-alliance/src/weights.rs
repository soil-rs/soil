...
//! Autogenerated weights for `plant_alliance`
//!
...
/// Weight functions needed for `plant_alliance`.
...
/// Weights for `plant_alliance` using the Substrate node and recommended hardware.
