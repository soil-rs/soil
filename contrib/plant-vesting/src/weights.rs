...
//! Autogenerated weights for `plant_vesting`
//!
...
/// Weight functions needed for `plant_vesting`.
...
/// Weights for `plant_vesting` using the Substrate node and recommended hardware.
