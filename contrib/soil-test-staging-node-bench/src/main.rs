...
use soil_test_staging_node_testing::bench::{BlockType, DatabaseType as BenchDataBaseType, KeyTypes};
...
#[derive(Debug, Parser)]
#[command(name = "soil-test-staging-node-bench", about = "Node integration benchmarks")]
struct Opt {
