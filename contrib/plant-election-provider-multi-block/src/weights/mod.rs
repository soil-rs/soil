...
pub mod traits {
	...
	pub mod pallet_election_provider_multi_block_unsigned {
		...
		/// Weight functions needed for `plant_election_provider_multi_block::unsigned`.
		pub trait WeightInfo {
	...
	pub mod plant_election_provider_multi_block {
		use super::*;

		/// Weight functions needed for `plant_election_provider_multi_block`.
		pub trait WeightInfo {
