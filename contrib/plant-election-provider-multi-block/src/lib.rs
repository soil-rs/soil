...
//!
//! > This pallet is sometimes abbreviated as `EPMB`, and `plant_election_provider_multi_phase` as
//! > `EPM`.
//!
//! ## Overall idea
//!
//! `plant_election_provider_multi_phase` provides the basic ability for NPoS solutions to be
...
pub use pallet::*;
pub use types::*;
pub use weights::traits::plant_election_provider_multi_block::WeightInfo;
