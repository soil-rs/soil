...
//! [`plant_election_provider_support::generate_solution_type`]. See the documentation of this macro
...
pub use plant_election_provider_support::{NposSolution, PageIndex};
use topsoil_support::{
...
pub type VoterOf<T> = plant_election_provider_support::Voter<
