...
//! Autogenerated weights for `plant_society`
//!
...
/// Weight functions needed for `plant_society`.
...
/// Weights for `plant_society` using the Substrate node and recommended hardware.
