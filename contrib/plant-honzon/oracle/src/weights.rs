...
//! Autogenerated weights for `plant_oracle`
//!
...
/// Weight functions needed for `plant_oracle`.
pub trait WeightInfo {
	fn feed_values(x: u32, ) -> Weight;
	fn on_finalize() -> Weight;
}

/// Weights for `plant_oracle` using the Substrate node and recommended hardware.
