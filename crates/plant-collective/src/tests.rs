...
parameter_types! {
	...
	pub const ProposalHoldReason: RuntimeHoldReason =
		RuntimeHoldReason::Collective(plant_collective::HoldReason::ProposalSubmission);
}
...
impl ExtBuilder {
	...
	pub fn build(self) -> subsoil::io::TestExternalities {
		let mut ext: subsoil::io::TestExternalities = RuntimeGenesisConfig {
			...
			collective: plant_collective::GenesisConfig {
				members: self.collective_members,
				phantom: Default::default(),
			},
			collective_majority: plant_collective::GenesisConfig {
...
fn genesis_build_panics_with_too_many_members() {
	...
	plant_collective::GenesisConfig::<Test> {
