...
//! Autogenerated weights for `plant_transaction_storage`
//!
...
// --steps=50
// --repeat=20
// --pallet=plant_transaction_storage
// --no-storage-info
// --no-median-slopes
// --no-min-squares
// --extrinsic=*
...
/// Weight functions needed for `plant_transaction_storage`.
...
/// Weights for `plant_transaction_storage` using the Substrate node and recommended hardware.
