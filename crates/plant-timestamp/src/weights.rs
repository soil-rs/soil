...
//! Autogenerated weights for `plant_timestamp`
//!
...
/// Weight functions needed for `plant_timestamp`.
pub trait WeightInfo {
	fn set() -> Weight;
	fn on_finalize() -> Weight;
}

/// Weights for `plant_timestamp` using the Substrate node and recommended hardware.
