...
//! Autogenerated weights for `plant_sassafras`
//!
...
/// Weight functions needed for `plant_sassafras`.
...
/// Weights for `plant_sassafras` using the Substrate node and recommended hardware.
