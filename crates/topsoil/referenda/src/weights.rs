...
//! Autogenerated weights for `topsoil_referenda`
//!
...
/// Weight functions needed for `topsoil_referenda`.
...
/// Weights for `topsoil_referenda` using the Substrate node and recommended hardware.
