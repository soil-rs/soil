...
//! Autogenerated weights for `topsoil_parameters`
//!
...
/// Weight functions needed for `topsoil_parameters`.
pub trait WeightInfo {
	fn set_parameter() -> Weight;
}

/// Weights for `topsoil_parameters` using the Substrate node and recommended hardware.
