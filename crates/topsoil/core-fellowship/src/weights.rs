...
//! Autogenerated weights for `topsoil_core_fellowship`
//!
...
// --pallet=topsoil_core_fellowship
...
/// Weight functions needed for `topsoil_core_fellowship`.
...
/// Weights for `topsoil_core_fellowship` using the Substrate node and recommended hardware.
