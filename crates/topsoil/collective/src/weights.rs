...
//! Autogenerated weights for `topsoil_collective`
//!
...
/// Weight functions needed for `topsoil_collective`.
...
/// Weights for `topsoil_collective` using the Substrate node and recommended hardware.
