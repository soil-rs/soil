...
//! Autogenerated weights for `topsoil_remark`
//!
...
/// Weight functions needed for `topsoil_remark`.
pub trait WeightInfo {
	fn store(l: u32, ) -> Weight;
}

/// Weights for `topsoil_remark` using the Substrate node and recommended hardware.
