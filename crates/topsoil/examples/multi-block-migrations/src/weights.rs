...
//! Autogenerated weights for `topsoil_example_mbm`
//!
...
/// Weight functions needed for `topsoil_example_mbm`.
pub trait WeightInfo {
	fn step() -> Weight;
}

/// Weights for `topsoil_example_mbm` using the Substrate node and recommended hardware.
