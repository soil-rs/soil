...
//! Autogenerated weights for `topsoil_example_tasks`
//!
...
/// Weight functions needed for `topsoil_example_tasks`.
pub trait WeightInfo {
	fn add_number_into_total() -> Weight;
}

/// Weights for `topsoil_example_tasks` using the Substrate node and recommended hardware.
