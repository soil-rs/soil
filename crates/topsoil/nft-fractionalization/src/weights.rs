...
//! Autogenerated weights for `topsoil_nft_fractionalization`
//!
...
// --pallet=topsoil_nft_fractionalization
...
/// Weight functions needed for `topsoil_nft_fractionalization`.
pub trait WeightInfo {
	fn fractionalize() -> Weight;
	fn unify() -> Weight;
}

/// Weights for `topsoil_nft_fractionalization` using the Substrate node and recommended hardware.
