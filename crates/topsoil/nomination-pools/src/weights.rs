...
//! Autogenerated weights for `topsoil_nomination_pools`
//!
...
/// Weight functions needed for `topsoil_nomination_pools`.
...
/// Weights for `topsoil_nomination_pools` using the Substrate node and recommended hardware.
