...
//! Autogenerated weights for `topsoil_asset_tx_payment`
//!
...
// --steps=50
// --repeat=20
// --pallet=topsoil_asset_tx_payment
// --no-storage-info
// --no-median-slopes
// --no-min-squares
// --extrinsic=*
...
/// Weight functions needed for `topsoil_asset_tx_payment`.
...
/// Weights for `topsoil_asset_tx_payment` using the Substrate node and recommended hardware.
