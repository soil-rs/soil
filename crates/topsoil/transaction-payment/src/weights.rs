...
//! Autogenerated weights for `topsoil_transaction_payment`
//!
...
// --pallet=topsoil_transaction_payment
...
/// Weight functions needed for `topsoil_transaction_payment`.
pub trait WeightInfo {
	fn charge_transaction_payment() -> Weight;
}

/// Weights for `topsoil_transaction_payment` using the Substrate node and recommended hardware.
