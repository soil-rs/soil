...
//! Autogenerated weights for `topsoil_nfts`
//!
...
/// Weight functions needed for `topsoil_nfts`.
...
/// Weights for `topsoil_nfts` using the Substrate node and recommended hardware.
