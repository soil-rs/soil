...
//! Autogenerated weights for `topsoil_fast_unstake`
//!
...
/// Weight functions needed for `topsoil_fast_unstake`.
...
/// Weights for `topsoil_fast_unstake` using the Substrate node and recommended hardware.
