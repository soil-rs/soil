...
//! Autogenerated weights for `topsoil_society`
//!
...
/// Weight functions needed for `topsoil_society`.
...
/// Weights for `topsoil_society` using the Substrate node and recommended hardware.
