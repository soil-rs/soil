...
//! Autogenerated weights for `topsoil_salary`
//!
...
/// Weight functions needed for `topsoil_salary`.
...
/// Weights for `topsoil_salary` using the Substrate node and recommended hardware.
