...
fn set_balance_handles_total_issuance() {
	ExtBuilder::default().build_and_execute_with(|| {
		let old_total_issuance = topsoil_balances::TotalIssuance::<Test>::get();
		assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), 1337, 69));
		assert_eq!(topsoil_balances::TotalIssuance::<Test>::get(), old_total_issuance + 69);
...
fn force_adjust_total_issuance_example() {
	ExtBuilder::default().build_and_execute_with(|| {
		...
		let old_ti = topsoil_balances::TotalIssuance::<Test>::get();
		...
		let new_ti = topsoil_balances::TotalIssuance::<Test>::get();
...
fn force_adjust_total_issuance_works() {
	ExtBuilder::default().build_and_execute_with(|| {
		...
		let ti = topsoil_balances::TotalIssuance::<Test>::get();

		// Increase works:
		assert_ok!(Balances::force_adjust_total_issuance(RawOrigin::Root.into(), Inc, 32));
		assert_eq!(topsoil_balances::TotalIssuance::<Test>::get(), ti + 32);
...
fn force_adjust_total_issuance_saturates() {
	ExtBuilder::default().build_and_execute_with(|| {
		...
		assert_eq!(topsoil_balances::TotalIssuance::<Test>::get(), max);
...
fn force_adjust_total_issuance_rejects_more_than_inactive() {
	ExtBuilder::default().build_and_execute_with(|| {
		...
		assert_eq!(topsoil_balances::TotalIssuance::<Test>::get(), 64);
		...
		assert_eq!(topsoil_balances::TotalIssuance::<Test>::get(), 16);
		...
		assert_eq!(topsoil_balances::TotalIssuance::<Test>::get(), 26);
...
fn burn_works() {
	ExtBuilder::default().build().execute_with(|| {
		...
		let init_issuance = topsoil_balances::TotalIssuance::<Test>::get();
		...
		assert_eq!(topsoil_balances::TotalIssuance::<Test>::get(), init_issuance - burn_amount_1);
