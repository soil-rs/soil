...
//! Autogenerated weights for `topsoil_offences`
//!
...
/// Weight functions needed for `topsoil_offences`.
pub trait WeightInfo {
	fn report_offence_grandpa(n: u32, ) -> Weight;
	fn report_offence_babe(n: u32, ) -> Weight;
}

/// Weights for `topsoil_offences` using the Substrate node and recommended hardware.
