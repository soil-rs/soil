...
//! Autogenerated weights for `topsoil_message_queue`
//!
...
/// Weight functions needed for `topsoil_message_queue`.
...
/// Weights for `topsoil_message_queue` using the Substrate node and recommended hardware.
