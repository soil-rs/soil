...
//! Autogenerated weights for `topsoil_lottery`
//!
...
/// Weight functions needed for `topsoil_lottery`.
...
/// Weights for `topsoil_lottery` using the Substrate node and recommended hardware.
