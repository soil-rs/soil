...
//! [`topsoil_election_provider_support::ElectionDataProvider::next_election_prediction`] is used to
//! estimate the time remaining to the next call to
//! [`topsoil_election_provider_support::ElectionProvider::elect`]. Based on this, a phase is chosen.
...
//! set, if this pallet is used with `topsoil-staking`). If the failure is for other technical
...
//!
//! The [`topsoil_election_provider_support::ElectionDataProvider`] and
//! [`topsoil_election_provider_support::ElectionProvider`] traits used by this pallet can support a
//! multi-page election.
//!
