...
//! Autogenerated weights for `topsoil_asset_conversion_ops`
//!
...
// --pallet=topsoil_asset_conversion_ops
...
/// Weight functions needed for `topsoil_asset_conversion_ops`.
pub trait WeightInfo {
	fn migrate_to_new_account() -> Weight;
}

/// Weights for `topsoil_asset_conversion_ops` using the Substrate node and recommended hardware.
