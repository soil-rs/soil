...
//! Autogenerated weights for `topsoil_treasury`
//!
...
/// Weight functions needed for `topsoil_treasury`.
...
/// Weights for `topsoil_treasury` using the Substrate node and recommended hardware.
