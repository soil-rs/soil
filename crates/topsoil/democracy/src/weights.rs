...
//! Autogenerated weights for `topsoil_democracy`
//!
...
/// Weight functions needed for `topsoil_democracy`.
...
/// Weights for `topsoil_democracy` using the Substrate node and recommended hardware.
