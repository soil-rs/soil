...
//! Autogenerated weights for `topsoil_verify_signature`
//!
...
// --pallet=topsoil_verify_signature
...
/// Weight functions needed for `topsoil_verify_signature`.
pub trait WeightInfo {
	fn verify_signature() -> Weight;
}

/// Weights for `topsoil_verify_signature` using the Substrate node and recommended hardware.
