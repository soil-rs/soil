...
//! Autogenerated weights for `topsoil_grandpa`
//!
...
/// Weight functions needed for `topsoil_grandpa`.
pub trait WeightInfo {
	fn check_equivocation_proof(x: u32, ) -> Weight;
	fn note_stalled() -> Weight;
}

/// Weights for `topsoil_grandpa` using the Substrate node and recommended hardware.
