...
//! Autogenerated weights for `topsoil_babe`
//!
...
/// Weight functions needed for `topsoil_babe`.
pub trait WeightInfo {
	fn check_equivocation_proof(x: u32, ) -> Weight;
}

/// Weights for `topsoil_babe` using the Substrate node and recommended hardware.
