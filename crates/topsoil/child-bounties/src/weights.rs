...
//! Autogenerated weights for `topsoil_child_bounties`
//!
...
/// Weight functions needed for `topsoil_child_bounties`.
...
/// Weights for `topsoil_child_bounties` using the Substrate node and recommended hardware.
