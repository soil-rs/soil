...
//! Autogenerated weights for `topsoil_transaction_storage`
//!
...
// --steps=50
// --repeat=20
// --pallet=topsoil_transaction_storage
// --no-storage-info
// --no-median-slopes
// --no-min-squares
// --extrinsic=*
...
/// Weight functions needed for `topsoil_transaction_storage`.
...
/// Weights for `topsoil_transaction_storage` using the Substrate node and recommended hardware.
