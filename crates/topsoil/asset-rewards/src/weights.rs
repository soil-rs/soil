...
//! Autogenerated weights for `topsoil_asset_rewards`
//!
...
/// Weight functions needed for `topsoil_asset_rewards`.
...
/// Weights for `topsoil_asset_rewards` using the Substrate node and recommended hardware.
