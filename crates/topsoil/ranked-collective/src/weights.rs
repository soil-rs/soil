...
//! Autogenerated weights for `topsoil_ranked_collective`
//!
...
// --pallet=topsoil_ranked_collective
...
/// Weight functions needed for `topsoil_ranked_collective`.
...
/// Weights for `topsoil_ranked_collective` using the Substrate node and recommended hardware.
