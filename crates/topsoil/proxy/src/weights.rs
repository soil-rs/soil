...
//! Autogenerated weights for `topsoil_proxy`
//!
...
/// Weight functions needed for `topsoil_proxy`.
...
/// Weights for `topsoil_proxy` using the Substrate node and recommended hardware.
