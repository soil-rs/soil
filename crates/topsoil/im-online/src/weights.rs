...
//! Autogenerated weights for `topsoil_im_online`
//!
...
/// Weight functions needed for `topsoil_im_online`.
pub trait WeightInfo {
	fn validate_unsigned_and_then_heartbeat(k: u32, ) -> Weight;
}

/// Weights for `topsoil_im_online` using the Substrate node and recommended hardware.
