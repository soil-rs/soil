...
//! Autogenerated weights for `topsoil_asset_rate`
//!
...
/// Weight functions needed for `topsoil_asset_rate`.
...
/// Weights for `topsoil_asset_rate` using the Substrate node and recommended hardware.
