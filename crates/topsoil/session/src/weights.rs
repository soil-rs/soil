...
//! Autogenerated weights for `topsoil_session`
//!
...
/// Weight functions needed for `topsoil_session`.
pub trait WeightInfo {
	fn set_keys() -> Weight;
	fn purge_keys() -> Weight;
}

/// Weights for `topsoil_session` using the Substrate node and recommended hardware.
