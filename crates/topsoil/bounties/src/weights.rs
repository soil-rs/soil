...
//! Autogenerated weights for `topsoil_bounties`
//!
...
/// Weight functions needed for `topsoil_bounties`.
...
/// Weights for `topsoil_bounties` using the Substrate node and recommended hardware.
