...
//! ## Dependencies
//!
//! This pallet depends on the [Session pallet](../plant_session/index.html).
...
impl<T: Config + plant_authorship::Config>
	plant_authorship::EventHandler<ValidatorId<T>, BlockNumberFor<T>> for Pallet<T>
{
