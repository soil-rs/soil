...
impl StateUsageStats {
	...
	pub fn merge_sm(&self, info: subsoil::state_machine::UsageInfo) {
	...
	pub fn take(&self) -> subsoil::state_machine::UsageInfo {
		use subsoil::state_machine::UsageUnit;
		...
		subsoil::state_machine::UsageInfo {
