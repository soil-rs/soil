...
//! Autogenerated weights for `plant_balances`
//!
...
/// Weight functions needed for `plant_balances`.
...
/// Weights for `plant_balances` using the Substrate node and recommended hardware.
