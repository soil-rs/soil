...
impl HeaderBackend<Block> for MockClient {
	fn header(&self, hash: Hash) -> soil_client::client_api::blockchain::Result<Option<Header>> {
	...
	fn status(&self, hash: Hash) -> soil_client::client_api::blockchain::Result<BlockStatus> {
...
impl BlockchainEvents<Block> for MockClient {
	...
	) -> soil_client::client_api::blockchain::Result<StorageEventStream<Hash>> {
		unimplemented!()
	}
}
