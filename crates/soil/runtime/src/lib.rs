...
/// ```rust
/// # fn main() {
/// soil_runtime::assert_eq_error_rate!(10, 10, 0);
/// soil_runtime::assert_eq_error_rate!(10, 11, 1);
/// soil_runtime::assert_eq_error_rate!(12, 10, 2);
/// # }
/// ```
///
/// ```rust,should_panic
/// # fn main() {
/// soil_runtime::assert_eq_error_rate!(12, 10, 1);
/// # }
/// ```
#[macro_export]
#[cfg(feature = "std")]
