...
//! Autogenerated weights for `plant_asset_conversion`
//!
...
/// Weight functions needed for `plant_asset_conversion`.
...
/// Weights for `plant_asset_conversion` using the Substrate node and recommended hardware.
