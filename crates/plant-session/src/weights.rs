...
//! Autogenerated weights for `plant_session`
//!
...
/// Weight functions needed for `plant_session`.
pub trait WeightInfo {
	fn set_keys() -> Weight;
	fn purge_keys() -> Weight;
}

/// Weights for `plant_session` using the Substrate node and recommended hardware.
