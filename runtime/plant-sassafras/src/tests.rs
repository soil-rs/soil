...
use subsoil::consensus::sassafras::Slot;
...
fn slot_ticket_id_outside_in_fetch() {
	...
	new_test_ext(0).execute_with(|| {
		...
		topsoil_core::system::Pallet::<Test>::set_block_number(One::one());
...
fn on_first_block_after_genesis() {
	...
	ext.execute_with(|| {
		...
		let consensus_log = subsoil::consensus::sassafras::digests::ConsensusLog::NextEpochData(
			subsoil::consensus::sassafras::digests::NextEpochDescriptor {
