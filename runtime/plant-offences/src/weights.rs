...
//! Autogenerated weights for `plant_offences`
//!
...
/// Weight functions needed for `plant_offences`.
pub trait WeightInfo {
	fn report_offence_grandpa(n: u32, ) -> Weight;
	fn report_offence_babe(n: u32, ) -> Weight;
}

/// Weights for `plant_offences` using the Substrate node and recommended hardware.
