...
pub mod pallet {
		...
		> + topsoil_system::Config
	{
		...
		/// the [`plant_asset_conversion::Config::Assets`] registry and can initiate the refund.
		...
		/// Retrieves information about an existing deposit for a given account ID and asset from
		/// the [`plant_asset_conversion::Config::PoolAssets`] registry and can initiate the
		/// refund.
		...
		/// [`plant_asset_conversion::Config::PoolAssets`] registry.
		...
		/// [`plant_asset_conversion::Config::Assets`] and
		/// [`plant_asset_conversion::Config::PoolAssets`] registries.
