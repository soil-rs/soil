...
//! Autogenerated weights for `plant_collective`
//!
...
/// Weight functions needed for `plant_collective`.
...
/// Weights for `plant_collective` using the Substrate node and recommended hardware.
