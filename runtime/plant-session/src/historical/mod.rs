...
use crate::{self as plant_session, Pallet as Session};
...
pub trait SessionManager<ValidatorId, FullIdentification>:
	plant_session::SessionManager<ValidatorId>
{
...
impl<T: Config, I> plant_session::SessionManager<T::ValidatorId> for NoteHistoricalRoot<T, I>
where
...
pub type IdentificationTuple<T> =
	(<T as plant_session::Config>::ValidatorId, <T as Config>::FullIdentification);
