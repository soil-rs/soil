...
pub trait StatementStoreApi:
	soil_statement_store::StatementStore + soil_statement_store::StatementStoreSubscriptionApi
{
}
impl<T> StatementStoreApi for T where
	T: soil_statement_store::StatementStore + soil_statement_store::StatementStoreSubscriptionApi
{
}
/// Statement store API
