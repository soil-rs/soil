...
use soil_transaction_pool::{TransactionStatus, TransactionStatusStream, TxIndex};
use sc_utils::mpsc;
...
/// term here means that it can be exposed to [`soil_transaction_pool::TransactionPool`] API
/// client e.g. over RPC.)
///
	...
	<<ChainApi as graph::ChainApi>::Block as BlockT>::Hash: Unpin,
{
	...
	/// (meaning that it can be exposed to [`soil_transaction_pool::TransactionPool`] API client
