...
//! [`ChainEvent`]: soil_transaction_pool::ChainEvent
//! [`TransactionStatusStreamFor`]: soil_transaction_pool::TransactionStatusStreamFor
//! [`api_submit`]: soil_transaction_pool::TransactionPool::submit_at
//! [`api_submit_and_watch`]: soil_transaction_pool::TransactionPool::submit_and_watch
//! [`ready_at_with_timeout`]: soil_transaction_pool::TransactionPool::ready_at_with_timeout
//! [`TransactionSource`]: soil_transaction_pool::TransactionSource
//! [TransactionPool API]: soil_transaction_pool::TransactionPool
//! [`TransactionStatus`]:soil_transaction_pool::TransactionStatus
//! [`Ready`]:soil_transaction_pool::TransactionStatus::Ready
//! [`Future`]:soil_transaction_pool::TransactionStatus::Future
//! [`Broadcast`]:soil_transaction_pool::TransactionStatus::Broadcast
//! [`Invalid`]:soil_transaction_pool::TransactionStatus::Invalid
//! [`InBlock`]:soil_transaction_pool::TransactionStatus::InBlock
//! [`Finalized`]:soil_transaction_pool::TransactionStatus::Finalized
//! [`Dropped`]:soil_transaction_pool::TransactionStatus::Dropped
//! [`ReadyTransactions`]:soil_transaction_pool::ReadyTransactions
