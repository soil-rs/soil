...
//!
//! NOTE: this assume the runtime implements [`topsoil_staking::Config`], as it requires an
...
fn existential_weight<T: topsoil_staking::Config>(
	total_issuance: u128,
...
pub fn generate_thresholds<T: topsoil_staking::Config>(
	n_bags: usize,
	output: &Path,
	total_issuance: u128,
	minimum_balance: u128,
