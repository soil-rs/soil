...
//! Autogenerated weights for `topsoil_elections_phragmen`
//!
...
// --pallet=topsoil_elections_phragmen
...
/// Weight functions needed for `topsoil_elections_phragmen`.
...
/// Weights for `topsoil_elections_phragmen` using the Substrate node and recommended hardware.
