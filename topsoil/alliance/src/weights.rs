...
//! Autogenerated weights for `topsoil_alliance`
//!
...
/// Weight functions needed for `topsoil_alliance`.
...
/// Weights for `topsoil_alliance` using the Substrate node and recommended hardware.
