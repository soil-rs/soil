...
//! Autogenerated weights for `topsoil_vesting`
//!
...
/// Weight functions needed for `topsoil_vesting`.
...
/// Weights for `topsoil_vesting` using the Substrate node and recommended hardware.
