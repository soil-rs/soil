...
//! Autogenerated weights for `topsoil_bags_list`
//!
...
/// Weight functions needed for `topsoil_bags_list`.
...
/// Weights for `topsoil_bags_list` using the Substrate node and recommended hardware.
