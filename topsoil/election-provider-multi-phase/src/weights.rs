...
//! Autogenerated weights for `topsoil_election_provider_multi_phase`
//!
...
// --pallet=topsoil_election_provider_multi_phase
...
/// Weight functions needed for `topsoil_election_provider_multi_phase`.
...
/// Weights for `topsoil_election_provider_multi_phase` using the Substrate node and recommended hardware.
