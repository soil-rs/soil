...
//! Autogenerated weights for `topsoil_conviction_voting`
//!
...
// --pallet=topsoil_conviction_voting
...
/// Weight functions needed for `topsoil_conviction_voting`.
...
/// Weights for `topsoil_conviction_voting` using the Substrate node and recommended hardware.
