...
//! Autogenerated weights for `topsoil_safe_mode`
//!
...
/// Weight functions needed for `topsoil_safe_mode`.
...
/// Weights for `topsoil_safe_mode` using the Substrate node and recommended hardware.
