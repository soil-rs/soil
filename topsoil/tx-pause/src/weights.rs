...
//! Autogenerated weights for `topsoil_tx_pause`
//!
...
/// Weight functions needed for `topsoil_tx_pause`.
pub trait WeightInfo {
	fn pause() -> Weight;
	fn unpause() -> Weight;
}

/// Weights for `topsoil_tx_pause` using the Substrate node and recommended hardware.
