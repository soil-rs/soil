...
//! Autogenerated weights for `topsoil_multi_asset_bounties`
//!
...
// --pallet=topsoil_multi_asset_bounties
...
// --no-min-squares
// --no-median-slopes
// --exclude-pallets=pallet_xcm,pallet_xcm_benchmarks::fungible,pallet_xcm_benchmarks::generic,topsoil_nomination_pools,topsoil_remark,topsoil_transaction_storage
...
/// Weight functions needed for `topsoil_multi_asset_bounties`.
...
/// Weights for `topsoil_multi_asset_bounties` using the Substrate node and recommended hardware.
