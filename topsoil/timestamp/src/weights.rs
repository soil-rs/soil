...
//! Autogenerated weights for `topsoil_timestamp`
//!
...
/// Weight functions needed for `topsoil_timestamp`.
pub trait WeightInfo {
	fn set() -> Weight;
	fn on_finalize() -> Weight;
}

/// Weights for `topsoil_timestamp` using the Substrate node and recommended hardware.
