...
//! Autogenerated weights for `topsoil_oracle`
//!
...
/// Weight functions needed for `topsoil_oracle`.
pub trait WeightInfo {
	fn feed_values(x: u32, ) -> Weight;
	fn on_finalize() -> Weight;
}

/// Weights for `topsoil_oracle` using the Substrate node and recommended hardware.
