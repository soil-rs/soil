...
//! Autogenerated weights for `topsoil_election_provider_multi_block`
//!
...
// pallet
// --pallet
// topsoil_election_provider_multi_block
// --extrinsic
// *
// --runtime
...
/// Weights for `topsoil_election_provider_multi_block`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: topsoil_system::Config> crate::weights::traits::topsoil_election_provider_multi_block::WeightInfo for WeightInfo<T> {
