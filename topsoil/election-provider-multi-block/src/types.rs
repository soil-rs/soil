...
//! [`topsoil_election_provider_support::generate_solution_type`]. See the documentation of this macro
...
pub type VoterOf<T> = topsoil_election_provider_support::Voter<
