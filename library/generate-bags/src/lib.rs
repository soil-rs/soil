...
//!
//!    ```sh,notrust
//!    $ cargo run -p soil-test-staging-node-generate-bags -- --total-issuance 1234 --minimum-balance 1
//! output.rs    ```
//!
...
fn existential_weight<T: plant_staking::Config>(
	total_issuance: u128,
...
pub fn generate_thresholds<T: plant_staking::Config>(
	n_bags: usize,
	output: &Path,
	total_issuance: u128,
	minimum_balance: u128,
