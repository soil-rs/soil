...
//! Provides utils for building the `Extrinsic` instances used with `soil-test-node-runtime`.
...
impl ExtrinsicBuilder {
	...
	pub fn new_deposit_log_digest_item(log: subsoil::runtime::generic::DigestItem) -> Self {
